...
| `/admin/availability`                 | admin     | admin                         | Single-day flow: pick a day → paint its walk windows (drag/resize/remove timeline) + per-day overnight & premium toggles                            |
...
_Last reviewed: 2026-07-08_ (added unclaimed/claimed*at/invited_at to profiles; /admin/clients/new + /claim routes; notifications suppressed while unclaimed)
\_Earlier: 2026-06-19* (copy POV rule: marketing body = Cal first person, non-marketing/system = third person about Cal; client-consent + transactional-email exceptions)
