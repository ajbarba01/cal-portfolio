...
| 4   | Payments complete+harden             | [spec](specs/2026-06-10-sp4-payments-design.md)              | [4a](plans/2026-06-10-sp4a-payments-flow.md) · 4b JIT                                              | **4a impl+review done; live verify pending CLI · 4b next** |
