/**
 * Integration tests for completion cron: runCompletionCron.
 *
 * Requires local Supabase running (SUPABASE_TEST_* env vars).
 * Unit tests for isCompletable live in completion-cron.test.ts.
 */

import { describe, it, expect, beforeAll, afterAll } from "vitest";
import { createClient } from "@supabase/supabase-js";
import { runCompletionCron } from "./completion-cron";
