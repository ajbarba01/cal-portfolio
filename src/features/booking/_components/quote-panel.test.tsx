...
describe("QuotePanel breakdown", () => {
  // The rows themselves are covered by quote-lines.test.tsx; this only holds
  // the panel to feeding its preview's breakdown through to them.
  it("renders the preview's lines above the total", () => {
    render(
      <QuotePanel
        preview={preview({
          breakdown: {
