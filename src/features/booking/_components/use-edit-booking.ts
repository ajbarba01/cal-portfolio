...
import type { validateStayRange } from "@/features/booking/calendar-model";
import { diffBookingPatch } from "@/features/booking/diff-booking-patch";
import { previewEdit } from "@/features/booking/preview-edit";
import type { QuantityState } from "@/features/booking/quantities";
...
import {
  useBookingScheduler,
  localDateFromKey,
  type UseBookingSchedulerReturn,
} from "@/features/booking/use-booking-scheduler";
...
import { usePremiumDays } from "@/features/booking/use-premium-days";
import type { SchedulerData } from "./scheduler";
import type { Pet } from "@/features/accounts/index.client";
import type { PetSpecies } from "@/features/pets";
import { isPetAware } from "@/features/pricing";
...
export interface UseEditBookingInput {
  ...
  /** One-way drive-time buffer for this booking's client, in minutes. */
